...
<div class="page-content">
  ...
  <div class="portlet box blue">
    ...
    <div class="portlet-body form">
      @if(isset($edit))
      {{Form::model($edit, ['route' => ['upd_apmodule', $edit],
       'id' =>'apmoduleValidation',
       'class'=>'FromSubmit',
       'method'=>'put',
       'redirect_url' =>route('apmoduleListMain')])}}
      {{ Form::text('id',old('id') ,['class' => 'form-control hidden'])
    }}  
    @else
    
    {!! Form::open(['route' => 'apmodulestore',
      'id' =>'apmoduleValidation',
      'class'=>'FromSubmit',
      'redirect_url' =>route('apmoduleListMain')]) !!}
      @endif   
      ...
      <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-actions">
          ...
          <a href="{{url('admin/apmodulelist')}}" type="button" class="btn default">Cancel</a>
        </div>
        {!! Form::close() !!}
      </div>
    </div>
